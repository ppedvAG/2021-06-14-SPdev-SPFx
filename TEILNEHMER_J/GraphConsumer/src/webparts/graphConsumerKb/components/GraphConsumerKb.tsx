...
import styles from './GraphConsumerKb.module.scss';
import * as strings from 'GraphConsumerKbWebPartStrings';
import { IGraphConsumerKbProps } from './IGraphConsumerKbProps';
...
export default class GraphConsumerKb extends React.Component<IGraphConsumerKbProps, IGraphConsumerState> {

  constructor(props: IGraphConsumerKbProps, state: IGraphConsumerState) {
    super(props);
  ...
  public render(): React.ReactElement<IGraphConsumerKbProps> {
    const { clientMode } = this.props;
    return (
      <div className={styles.graphConsumerKb}>
